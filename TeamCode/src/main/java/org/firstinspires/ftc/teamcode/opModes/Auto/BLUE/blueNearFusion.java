...
@Configurable
public class blueNearFusion extends IvyOpMode {
...
//                waitMs((0.3) * 1000.0),
    ...
    public class Paths {
        ...
        Pose GATE_1                      = POSES.of(39, 70, Math.toRadians(-151));
        Pose GATE_2                      = POSES.of(29, 63, Math.toRadians(151));
        Pose GATE_3                      = POSES.of(10.9, 57.75, Math.toRadians(144));
        Pose GATE_SHOOT_1                = POSES.of(36, 59, Math.toRadians(-151));
        Pose GATE_SHOOT_2                = POSES.of(56, 79, Math.toRadians(-151));
        Pose PARK_POSE                   = POSES.of(49, 71, 0);

        public Paths(TeamFollower follower) {
            shootPreloads = line(start, POSES.of(51.495, 94.650, 0)).linear(Math.toRadians(-90),
                            Math.toRadians(-60));

            intakeSpike2 = curve(POSES.of(51.495, 94.650, 0),
                            POSES.of(53.02, 59.7, 0),
                            POSES.of(21, 59.5, 0)).linear(Math.toRadians(-60),
                            Math.toRadians(160));

            shootSpike2 = line(POSES.of(21.000, 59.500, 0),
                                    GATE_SHOOT_2).linear(Math.toRadians(160), Math.toRadians(-152));
