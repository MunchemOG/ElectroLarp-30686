...
@Disabled
@Autonomous(name = "Blue Mid V3")
@Configurable
public class blueMegumi extends NextFTCOpMode {
...
//                // --- Sweep cycle 5 ---
    ...
    public class Paths {
        ...
        Pose SWEEP_1 = new Pose(11, 84.2, Math.toRadians(180));
        Pose SWEEP_2 = new Pose(12, 81.7, Math.toRadians(240));
        Pose SWEEP_2_CONTROL = new Pose(16.7, 82.5);
        Pose SWEEP_3 = new Pose(11.5, 70.2, Math.toRadians(240));
