...
public class ShooterCalc implements Subsystem {
    ...
    public static Double[] calculateShotVectorandUpdateHeading(double robotHeading, PolarVector robotToGoalVector, PolarVector robotVel, double sotmFactorr){
        double g = 32.174*12;
