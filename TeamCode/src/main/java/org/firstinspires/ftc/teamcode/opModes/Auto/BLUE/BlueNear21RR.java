...
@Autonomous(name = "Blue Close 21 RR")
@Configurable
public class BlueNear21RR extends NextFTCOpMode {
...
//                new Delay(0.3),
    ...
    public class Paths {
        ...
        // Close24AutoPathsMTI (this file is the BLUE mirror of redNear21RR): x' = 144 - x, y' = y, heading' = normalizeAngle(pi - heading).
        ...
        public Paths(Follower follower) {
            shootPreloads = follower.pathBuilder()
                    .addPath(new BezierLine(start, new Pose(44, 122)))
            ...
            shootSpike2 = follower.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(160), Math.toRadians(-153))
                    .setTValueConstraint(0.95)
                    .addPoseCallback(new Pose(41.477, 71.095),intakeMotorOff,0.6)
                    .build();
            ...
            shootSpike1 = follower.pathBuilder()
                    ...
                    .setTValueConstraint(0.95)
                    .setLinearHeadingInterpolation(Math.toRadians(173), Math.toRadians(-153))
                    .addPoseCallback(new Pose(38.324, 81.139),intakeMotorOff,0.6)
                    .build();

            quickerGate = follower.pathBuilder()
                    .addPath(new BezierLine(GATE_SHOOT_2, new Pose(34, 68)))
                    .setTangentHeadingInterpolation()
                    .addPath(new BezierLine(new Pose(34, 68), GATE_3))
                    .setTValueConstraint(0.95)
                    .setLinearHeadingInterpolation(Math.toRadians(-153), Math.toRadians(151), 0.5)
                    .build();

            quickerGate2 = follower.pathBuilder()
                    .addPath(new BezierLine(GATE_SHOOT_2, new Pose(34, 68)))
                    .setTangentHeadingInterpolation()
                    .addPath(new BezierLine(new Pose(34, 68), new Pose(GATE_3.getX(), GATE_3.getY()+0.08)))
                    .setLinearHeadingInterpolation(Math.toRadians(-153), GATE_3.getHeading(), 0.5)
                    .setTValueConstraint(0.95)
                    .build();
