...
public class LaunchDetectorCRI {
        ...
        private static final Triangle LARGE_LAUNCH_ZONE = new Triangle(96.0, 96.0, 192.0, 192.0, 0.0, 192);
        private static final Triangle SMALL_LAUNCH_ZONE = new Triangle(72.0, 48.0, 96, 71, 118.0, 48.0);
